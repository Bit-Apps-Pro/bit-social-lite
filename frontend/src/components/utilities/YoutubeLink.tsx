...
const docsLink: Record<string, string> = {
  ...
  instagram: 'https://youtu.be/m44aFan4Nr4?si=Ro51TteqKr8kpnNq',
  line: 'https://youtu.be/V_FyW_pK7ec?si=jgUU1NBiI3W9hplv',
  linkedin: 'https://www.youtube.com/watch?v=YcmVEq3GGsk',
  pinterest: 'https://www.youtube.com/watch?v=6deQqqhMYLY',
  threads: 'https://youtu.be/VZUxncswKfw?si=y1YkjxWAin4iHETN',
