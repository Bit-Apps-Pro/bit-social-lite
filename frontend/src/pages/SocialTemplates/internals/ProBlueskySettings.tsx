...
export default function ProBlueskySettings() {
  ...
  const handleChange: KeyedValueHandler<SocialTemplates['bluesky']> = (key, val) => {
    setTemplates(prev =>
      produce(prev, draft => {
        draft.bluesky[key] = val
      })
    )
  }
        ...
        <Col span={14}>
          ...
          <Card style={{ marginTop: 10 }}>
            <Flex gap={20} justify="space-between">
              ...
              <div>
                <Switch
                  checked={templates.bluesky.trimMessage}
